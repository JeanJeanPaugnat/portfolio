  ...
  return (
    <main className='mt-64'>
      <div className='px-22'>
        ...
        <div className='flex justify-between gap-22 py-32'>
          <div className='flex flex-col justify-between max-w-3xl gap-20'>
            <p className='font-sans text-xl leading-8'>{project.description}</p>
        ...
        <div className='flex justify-between uppercase border-t-[1px] border-background pt-6'>
      ...
      <div className='px-22 pt-14'>
        ...
        <div className='border-t-[1px] border-background pt-6'>
