export default function ScrollIndicator() {
  return (
    <div className="flex items-center gap-2 sm:gap-4 mb-8 sm:mb-12">
      {/* Flèche Gauche */}
      <svg className="w-3 h-6 sm:w-4 sm:h-7" viewBox="0 0 15 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="capitalize text-sm sm:text-base font-medium" style={{ color: 'var(--neutral-900)' }}>
        scroll down
      </p>
